...
export function CourseListPage(props: CourseListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCourses({
        relations: ['institute', 'enquiry.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('institute', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'institute',
          header: 'Institute',
          accessorKey: 'institute',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/institutes/view/${record.institute?.id}`}>
    ...
    hasAccess('enquiry', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Enquiry',
          accessorKey: 'enquiry',
          cell: ({ row: { original: record } }: any) => record?._count?.enquiry,
        }
      : null,
